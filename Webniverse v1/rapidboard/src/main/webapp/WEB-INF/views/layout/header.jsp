                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <sec:authorize access="isAuthenticated()">
                                <li class="nav-item">
                                    <a class="nav-link" href="/member/${principal.member.memberId}">My Page</a>
                                </li>
                            </sec:authorize>
                            <sec:authorize access="isAnonymous()">
                                <li class="nav-item">
                                    <a class="nav-link" href="/auth/signin">My Page</a>
                                </li>
                            </sec:authorize>
                        ...
                        <sec:authorize access="isAuthenticated()">
                            <a style="margin-left: 5px" type="button" class="btn btn-outline-success" href="/post/post/${principal.member.memberId}">Post</a>
                        </sec:authorize>
                    </div>
                </div>
            </nav>
