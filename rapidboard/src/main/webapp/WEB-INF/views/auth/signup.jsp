...
<body class="text-center" style="background: url('/images/background2.jpg'); background-size: 1800px">
    ...
    <main class="form-signin">
        ...
        <h1 class="h3 mb-3 fw-bold text-white">Please sign up!</h1>
        <form id="signupForm" action="/auth/signup" method="POST" class="bg-white p-2 rounded-3">
            <div class="form-floating">
                ...
                <a id="usernameCheckBtn" class="btn btn-sm btn-primary" style="width: 50%; font-size: 13px; margin-bottom: 5px"><b>Check</b></a>
            </div>
