...
import com.example.rapidboard.service.*;
...
public class PostController {
    ...
    public String postList(Model model, @PageableDefault(size = 5) Pageable pageable) {
        ...
        model.addAttribute("boardName", "전체 게시글");
    ...
    public String home(Model model) {
        log.info("home");
        Webinar currentMainWebinar = webinarService.mainWebinar();
        if (currentMainWebinar != null) model.addAttribute("mainRoom", currentMainWebinar);
